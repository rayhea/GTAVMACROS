...
#include %A_WorkingDir%\temp\lib\Vis\JSON.ahk
...
class Vis2 {
   ...
   class provider {
      ...
      class Tesseract {
         ...
         static leptonica := A_ScriptDir "\temp\lib\Vis\bin\leptonica_util\leptonica_util.exe"
         static tesseract := A_ScriptDir "\temp\lib\Vis\bin\tesseract\tesseract.exe"
         static tessdata_best := A_ScriptDir "\temp\lib\Vis\bin\tesseract\tessdata_best"
         static tessdata_fast := A_ScriptDir "\temp\lib\Vis\bin\tesseract\tessdata_fast"
